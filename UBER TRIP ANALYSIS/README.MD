...
* Trip ID – A unique identifier assigned to each Uber trip. This helps in tracking individual trips.
...
* Trip Distance – The distance covered during a trip, typically measured in miles. Used for fare calculation, efficiency analysis, and identifying long or short trips.
...
* DOLocationID (Drop Off Location ID) – A numerical code for the drop-off location. Used for location analysis, efficiency analytics, and demand forecasting.

* Payment Type – The mode of payment for the trip, e.g., credit card, cash. Helps in financial analysis and understanding customer preferences.
...
* Surcharge Fee – The extra charge applied during high-demand periods. Helps in understanding surge pricing patterns and peak hour demand.
